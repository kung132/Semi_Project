 ...
 */
@WebServlet("/searchFilter.ht")
	public class SelectListFilterController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectListFilterController() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 리스트 갯수
		listCount = new HotelService().selectListCountFilter(city, state, star, minPay, maxPay, hotelName);
		...
		// service단으로
		ArrayList<Hotel> list = new HotelService().selectListFilter(hotelName, star, minPay, maxPay, city, state, pi);
